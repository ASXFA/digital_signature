$(function(){
    ...
    $('#pengajuan-page').attr('class','nav-link active');
            ...
            success:function(result){
                ...
                for(var i=0; i<result.pengesah.length; i++){
                    ...
                    if (result.pengesah[i].status == 0) {
                        var ht = '<i class="fa fa-times text-danger" title="Belum ditanda tangani"></i>';
                    }else{
                        var ht = '<i class="fa fa-check text-success" title="Sudah ditanda tangani"></i>';
                    }
